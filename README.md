...
The game includes a ‘god mode’ — activated by pressing the ‘G’, ‘O’, and ‘D’ keys together — which strengthens K9's laser and shield. You can also load any level by pressing keys '1' to '6', and use the arrow keys to scroll around a level.
