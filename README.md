...
The project uses a custom build step to invoke [BeebAsm](https://github.com/stardot/beebasm) which assembles the code and creates a disc image (**program.ssd**) containing the program and levels. The project debug settings invoke [BeebEm](https://github.com/stardot/beebem-windows) to run/debug the game. The paths to BeebEm and BeebAsm will likely need updating.
